...
package enum VTTParser {
    ...
    package static func parse(at url: URL) throws -> [Segment] {
    ...
    package static func dedupe(_ segs: [Segment]) -> [Segment] {
...
package enum SubsDispatcher {
    package static func parse(_ file: DownloadedSubFile) -> [Segment] {
        switch file.ext {
        case "vtt":
